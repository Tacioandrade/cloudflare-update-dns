...
class AppLocalizations {
  ...
  static const _translations = <String, Map<String, String>>{
    'en': {
      ...
      'unableOpenLink': 'Unable to open the link.', 'developedBy': 'Developed by ',
      ...
      'deleteRecord': 'Delete record {name}?', 'delete': 'Delete', 'unableOpenWebsite': 'Unable to open the website.',
    },
    'pt': {
      ...
      'developedBy': 'Desenvolvido por ', 'credentialsInvalid': 'Credenciais inválidas!', 'biometricReason': 'Autentique-se para gerenciar seus domínios DNS',
